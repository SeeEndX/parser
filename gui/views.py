...
class CheckboxFrame(ctk.CTkFrame):
    ...
    def apply_button_callbck(self):
        if len(app.checkbox_frame.get())<1:
            ...
            print("\nНастройки применены!\n")
            print("Выбранные сайты:", app.checkbox_frame.get())
...
class ButtonFrame(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.start_button = ctk.CTkButton(self, text="Начать", command=app.start_button_callbck,font=ctk.CTkFont(size=16))
        self.start_button.grid(row=0, column=0, padx=10, pady=10)
        self.stop_button = ctk.CTkButton(self, text="Остановить", 
                       command=app.stop_button_callbck, 
                       fg_color="Red",
                       hover_color="DarkRed",
